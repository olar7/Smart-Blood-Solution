        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">@lang('component')</h3>
                    <a href="{{route('component.create')}}" class="btn btn-success pull-right">@lang('new')</a>
                </div>
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('global.component.fields.component')</th>
                            ...
                            @if ($components->count() > 0)
                                ...
                                @foreach ($components as $component)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{route('component.edit', ['component' => $component->id])}}" data-toggle="tooltip" title="@lang('global.app_edit')" class="btn btn-info btn-sm">
