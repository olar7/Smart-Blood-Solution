  ...
  <path d="M2 11h1v1H2v-1zm2 0h1v1H4v-1zm-2 2h1v1H2v-1zm2 0h1v1H4v-1zm4-4h1v1H8V9zm2 0h1v1h-1V9zm-2 2h1v1H8v-1zm2 0h1v1h-1v-1zm2-2h1v1h-1V9zm0 2h1v1h-1v-1zM8 7h1v1H8V7zm2 0h1v1h-1V7zm2 0h1v1h-1V7zM8 5h1v1H8V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm0-2h1v1h-1V3z"/>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/bedonor">Become a Donor</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="/donorreq">Request a Donor</a>
        </li>
        <li class="nav-item">
        ...
        <div id= "login-icon">
        <a class="nav-link active" href="#"><i class="bi bi-person-fill"></i></a>
...
<div class="footer">
  ...
  <footer id="sticky-footer" class="flex-shrink-0 py-4 bg-dark text-white-50">
    <div class="container text-center">
      <large>Copyright &copy; Blood bank</large>
    </div>
  </footer>
</div>
